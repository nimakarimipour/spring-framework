...
public class WebAsyncTask<V> implements BeanFactoryAware {
	...
	CallableProcessingInterceptor getInterceptor() {
		return new CallableProcessingInterceptor() {
			@Override
			public <T> Object handleTimeout(@Nullable NativeWebRequest request, Callable<T> task) throws Exception {
				return (timeoutCallback != null ? timeoutCallback.call() : CallableProcessingInterceptor.RESULT_NONE);
			}
			@Override
			public <T> Object handleError(@Nullable NativeWebRequest request, Callable<T> task, Throwable t) throws Exception {
